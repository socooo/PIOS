...
int randints[60] = {
	31,16,23,6,8,21,48,60,38,56,3,17,28,5,47,11,39,36,59,46,22,13,9,50,41,20,30,
	14,24,32,34,49,37,55,40,25,45,1,18,29,2,58,7,35,19,4,33,26,10,44,51,15,
	42,52,12,27,53,54,43,57};
const int sortints[60] = {
